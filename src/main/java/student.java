...
public class student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Show Student", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Roboto", 1, 18))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String stdBranch = branch.getText();
            String sql = "UPDATE student SET stdName= '"+stdName+"',stdRollno='"+stdRollno+"',stdFatherName='"+stdFatherName+"',stdBlood='"+stdBlood+"',stdPhone='"+stdPhone+"',stdCity='"+stdCity+"',stdBranch='"+stdBranch+"' WHERE id ='"+stdId+"' ";
            stmt.execute(sql);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
           ...
           if(rs.next()){
               ...
               rollno.setText(rs.getString("stdRollno"));
               ...
               branch.setText(rs.getString("stdBranch"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            stmt.execute(sql);
            JOptionPane.showMessageDialog(null, "Student delet ed!");
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
